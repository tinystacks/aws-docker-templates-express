 ...
 */
export async function getMysqlItem(req: Request, res: Response) {
 ...
 */
export async function createMysqlItem(req: Request, res: Response) {
  addHeadersToResponse(res);
 ...
 */
export async function updateMysqlItem(req: Request, res: Response) {
  addHeadersToResponse(res);
 ...
 */
export async function deleteMysqlItem(req: Request, res: Response) {
  addHeadersToResponse(res);
